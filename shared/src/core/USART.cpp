...
namespace
{
std::array<stm32f4::USARTConfig, stm32f4::USERCUSTOM> buildConfigs()
{
    std::array<stm32f4::USARTConfig, stm32f4::USERCUSTOM> retVal;
    stm32f4::USARTConfig usart1_1;
    ...
    retVal[stm32f4::USART1_1] = usart1_1;

//// USART1_2
    stm32f4::USARTConfig usart1_2;
    ...
    retVal[stm32f4::USART1_2] = usart1_2;

//// USART2_1
    stm32f4::USARTConfig usart2_1;
    ...
    retVal[stm32f4::USART2_1] = usart2_1;

//// USART2_2
    stm32f4::USARTConfig usart2_2;
    ...
    retVal[stm32f4::USART2_2] = usart2_2;

//// USART6_1
    stm32f4::USARTConfig usart6_1;
    ...
    retVal[stm32f4::USART6_1] = usart6_1;

//// USART6_2
    stm32f4::USARTConfig usart6_2;
    ...
    retVal[stm32f4::USART6_2] = usart6_2;
...
void USART::start()
{
    // Setup the gpio pins first?
    gpio_mode_setup(_config.txPinPort,
                    GPIO_MODE_AF,
                    GPIO_PUPD_NONE,
                    _config.txPin);
    gpio_set_af(_config.txPinPort,
                _config.gpio_AF,
                _config.txPin);
    gpio_mode_setup(_config.rxPinPort,
                    GPIO_MODE_AF,
                    GPIO_PUPD_NONE,
                    _config.rxPin);
    gpio_set_af(_config.rxPinPort,
                _config.gpio_AF,
                _config.rxPin);
    gpio_mode_setup(_config.ckPinPort,
                    GPIO_MODE_AF,
                    GPIO_PUPD_NONE,
                    _config.ckPin);
    gpio_set_af(_config.ckPinPort,
                _config.gpio_AF,
                _config.ckPin);
    
    if(_config.hasCtsRts)
    {
        if(_config.useCtsRts)
        {
            gpio_mode_setup(_config.ctsPinPort,
                            GPIO_MODE_AF,
                            GPIO_PUPD_NONE,
                            _config.ctsPin);
            gpio_set_af(_config.ctsPinPort,
                        _config.gpio_AF,
                        _config.ctsPin);
            gpio_mode_setup(_config.rtsPinPort,
                            GPIO_MODE_AF,
                            GPIO_PUPD_NONE,
                            _config.rtsPin);
            gpio_set_af(_config.rtsPinPort,
                        _config.gpio_AF,
                        _config.rtsPin);
...
void USART::write(uint8_t* data, uint32_t len)
{
    for(uint32_t i = 0; i < len; ++i)
    {
        usart_send_blocking(_config.usartNum,
